...
`mqlite`, matching the provided rules. Restrict metrics routing with your existing
network policy without blocking legitimate producer/consumer traffic on the same
broker port.
